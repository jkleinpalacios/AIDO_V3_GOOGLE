...
const MiningGazettePage: React.FC = () => {
    return (
        <div className="bg-slate-50 min-h-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                {/* Header Section */}
                <div className="text-center mb-16">
                    <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Boletín Oficial de Minería</h1>
                    ...
                    <p className="mt-3 text-sm font-medium text-slate-500">
                        Interpretación generada por IA basada en la edición oficial del día.
                    </p>
                </div>

                {/* Subsections Grid */}
                <div className="max-w-5xl mx-auto">
                    <p className="mb-8 text-lg text-center text-slate-700">Estas son las 16 subsecciones oficiales del Boletín de Minería:</p>
                    <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
                        {MINING_SUBSECTIONS.map((subsection) => {
                            ...
                            if (subsection.hasContent) {
                                return (
                                    <Link 
                                        to={`/search?section=boletin-mineria&subsection=${subsection.id}`}
                                        key={subsection.id} 
...
export default MiningGazettePage;