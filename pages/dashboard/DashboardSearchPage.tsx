        ...
        <div className="space-y-8">
            ...
            <div className="grid lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8">
                    {loading && <div className="text-center p-8 bg-white rounded-xl border border-slate-200">Cargando respuesta...</div>}
                    {!results && !loading && (
                        <EmptyState 
                            ...
                            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    {results.documents.map((doc: any) => (
                                        <Link to={`/dashboard/documentos/${doc.id}`} key={doc.id} className="block bg-white p-4 rounded-lg border border-slate-200 hover:border-blue-400 hover:bg-slate-50 transition-all">
